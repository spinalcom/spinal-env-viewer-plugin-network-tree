...
export default {
    ...
    _formatEquipmentAttribute(tree, equipments, separator, indice) {
        ...
        return equipments.map((iterator) => {
            ...
            const obj = {
                ...
                namingConvention: iterator.property.displayValue.split(separator).splice(indice).join(separator)
            }
    ...
    async _createBimObjectNode({ dbId, model, namingConvention, color }) {
