 ...
 -->
    <div class="items">
      <div class="physical_automates">
        <div class="title">Automate Items</div>
        <div class="lists">
          <div class="list"
      ...
      <div class="virtual_automates">
        <div class="title">Profil Items</div>
        <div class="lists">
          <div class="list"
...
export default {
  ...
  methods: {
    linkItems() {
      let automateIndice;
      const automateItemFound = this.data.invalidAutomateItems.find(
        (el, index) => {
          if (el.id === this.automateItemSelected) {
            automateIndice = index;
            return true;
          }
          return false;
        }
      ...
      let profileIndice;
      const profileItemFound = this.data.invalidProfileItems.find(
        (el, index) => {
          if (el.id === this.profileItemSelected) {
            profileIndice = index;
            return true;
          }
          return false;
    ...
    unLinkItems(automateItemId, profileItemId) {
      let indice;
      const found = this.data.valids.find((item, index) => {
        if (
